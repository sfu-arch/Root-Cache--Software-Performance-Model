...
sbit_cache = (([2.37, 2.07, 4.1,3.01,2.17,4.21,3.11,2.3,4.47]))
ebit_cache = (([3.71,2.18,4.16,4.17,3.36,4.89,5.23,4.76,5.3]))
tbit_cache = (([2.14,1.96,3.06,2.96,2.07,3.17,3.06,2.21,3.28]))
