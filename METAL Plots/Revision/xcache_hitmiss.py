...
percentage = read_file("barstackxcache.txt")
# onemin = []
...
plt.annotate("B+ Tree Search",     (0.12,-0.200), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
...
plt.tight_layout()
plt.savefig('./Plots/pdfs/xcachelevelstraversedperhit.pdf')
plt.show()