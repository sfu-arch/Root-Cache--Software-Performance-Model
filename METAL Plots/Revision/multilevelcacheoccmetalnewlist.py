...
plt.annotate("B+Tree Search",(0.0,-0.1), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
plt.annotate("Hash",(0.22,-0.1), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
plt.annotate("SpMV",(0.37,-0.1), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
plt.annotate("Analy.",(0.52,-0.1), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
plt.annotate("SpMM",(0.68,-0.1), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
plt.annotate("Rtree",(0.86,-0.1), xycoords='axes fraction', textcoords='offset points', va='top', size = font ,weight='bold')
...
plt.tight_layout()
plt.savefig('./Plots/pdfs/multiidx.pdf')
plt.show()