...
ax.plot (BM_name,[(livia_1l[i]*1 + livia_l2[i]*2 + livia_641[i]*100) for i in range(len(r80_64))],marker="o",color="orange",markersize=20,linewidth=5)
...
plt.savefig("pdfs/MetalvLivia_depth.jpeg")
plt.show()